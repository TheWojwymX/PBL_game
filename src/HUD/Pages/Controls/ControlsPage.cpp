...
void ControlsPage::Init() {
    ...
    SetupButtons();
    _backButton->Init();
    _buttonsBackground.Init("res/Images/MainMenuSettings/settings_control.png", CoordsConverter::ConvertCoords(glm::vec2(403, 839)), CoordsConverter::ConvertCoords(glm::vec2(1516, 370)), true, false);
...
void ControlsPage::SetupButtons() {
    _backButton = std::make_shared<Button>("res/Images/Button/button_back.png",
                                           ...
                                           CoordsConverter::ConvertCoords(glm::vec2(1283, 808)),
                                           CoordsConverter::ConvertCoords(glm::vec2(1485, 755)),
                                           [this]() {
                                               if (_mode == 0) {
