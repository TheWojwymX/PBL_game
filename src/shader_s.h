...
public:
    ...
    void setVec3(const std::string& name, float* array) const
    {
        glUniform3f(glGetUniformLocation(ID, name.c_str()), array[0], array[1], array[2]);
    }
    // ------------------------------------------------------------------------
    ...
    void setVec4(const std::string& name, float* array) const
    {
        glUniform4f(glGetUniformLocation(ID, name.c_str()), array[0], array[1], array[2], array[3]);
    }
    // ------------------------------------------------------------------------
