...
public:
    ...
    PlayerController(float speed = 8.0f, float gravity = 0.0f, float jumpHeight = 3.0f, float groundLevel = 0.5f, float reach = 10.0f, int radius = 3, float width = 0.5f, float height = 1.8f);
